...
;
; History:
; v1.9 - Manually load edited text from editor https://github.com/lintalist/lintalist/issues/268
...
ControlGetText, CheckEditorState, Button3, Lintalist snippet editor
if (CheckEditorState = "1 - Edit in Editor") 
	{
	 ControlSetText, Button3, Load From File, Lintalist snippet editor
	 EditControlInEditor("Text1")
	}
else
	{
	 Gosub, UpdateFromFile
	 ControlSetText, Button3, 1 - Edit in Editor, Lintalist snippet editor
	}
Return
...
ControlGetText, CheckEditorState, Button4, Lintalist snippet editor
if (CheckEditorState = "2 - Edit in Editor") and !ExternalEditorMonitorStatus
	{
	 ControlSetText, Button4, Load From File, Lintalist snippet editor
	 EditControlInEditor("Text2")
	}
else
	{
	 Gosub, UpdateFromFile
	 ControlSetText, Button4, 2 - Edit in Editor, Lintalist snippet editor
	}
Return
...
ControlGetText, CheckEditorState, Button5, Lintalist snippet editor
if (CheckEditorState = "3 - Edit in Editor") and !ExternalEditorMonitorStatus
	{
	 ControlSetText, Button5, Load From File, Lintalist snippet editor
	 EditControlInEditor("Script")
	}
else
	{
	 Gosub, UpdateFromFile
	 ControlSetText, Button5, 3 - Edit in Editor, Lintalist snippet editor
	}
Return

EditControlInEditor(ControlID)
	{
	 Global WhichControl,SnippetEditor,TmpDir, RC1, RC2, RC3, RCID, EditorSyntaxHL, ExternalEditorMonitorStatus, EditorTempFileExtension
